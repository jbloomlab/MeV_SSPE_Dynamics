...
# ggsave(paste(figure.dir, "extended-data-figure-9.tiff", sep=""), device = "tiff", width = 19, height = 10)
...
ggsave(paste(figure.dir, "figure-7a.tiff", sep=""), device = "tiff", width = 11.25, height = 10, dpi = 300)
