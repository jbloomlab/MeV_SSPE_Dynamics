...
We can see these mutations clearly in the SSPE 2 pilot sample if we draw 'gates' of frequency around mutations on the plot. Below, I'm drawing 'gates' around 65-80% and 20-35% of the genome respectively.
...
sspe.2.df = selected.variants.df %>% 
