...
First, it's clear that `cluster 9` and `genome-1-1` are opposite and opposed clusters that both originate from a `genome-1` background. Everything on `genome-1` originates on one of these two backgrounds. 
