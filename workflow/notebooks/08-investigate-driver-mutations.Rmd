...
names(haplotype.colors) = c("G-01", "G-FC2", "G-1", "G-2")
...
ggplot(data = core.snps, aes(x = factor(Tissue, levels = (expanded_tissue_order)), y = AF, color = Genotype)) +
  geom_jitter(data = subclonal.snps, color = "#878484", size = .75, width = 0.25, alpha = 0.75) + 
  ...
  scale_fill_manual(values = haplotype.colors, guide = "none") +
  scale_shape_manual(values=c(21,22,24))+
  theme_bw(20) +
  theme(axis.text.x = element_text(angle = 35, hjust=1)) 
  
ggsave(paste(figure.dir, "updated-figure-4b.png"), width = 14, height = 7, dpi = 300)
...
main.genotypes %>% 
  ggplot(aes(x = POS, y = AF, col = Genotype)) +
    ...
    scale_color_manual(values = c("#87CEEB", "#00008B", "#B63F3E", "black")) +
    theme_bw(18) +
    theme(legend.position="bottom")
  
ggsave(paste(figure.dir, "updated-figure-6.png"), width = 15, height = 8, dpi = 300)
