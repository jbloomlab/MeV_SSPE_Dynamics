...
The goal of this notebook is to establish a method to genotype SNPs as either belonging to `Genome 1` or to `Genome 2`. **The output of this notebook is a set of phased variants with genome 1 and genome 2 background assignments.**
