...
# Haplotype order - sequentialy by frequency
...
```{r Cluster 6, fig.align='center', fig.width=8, fig.height=5, echo=T}
...
```{r Cluster 6 Non-matrix, fig.align='center', fig.width=8, fig.height=5, echo=T}
...
```{r Exclude Reccurent SNPs from Cluster 6, fig.align='center', fig.width=8, fig.height=5, echo=T}
...
```{r Cluster 12, fig.align='center', fig.width=8, fig.height=5, echo=T}
...
```{r Clean Up Cluster 12, fig.align='center', fig.width=8, fig.height=5, echo=T}
...
distribution.df = labeled.df %>% 
  ...
  mutate(Haplotype = case_when(
    Haplotype == "genome-1" ~ "genome 01a",
    Haplotype == "genome-1-1" ~ "genome 01b",
