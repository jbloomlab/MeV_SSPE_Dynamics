...
First, using the previous notebook (`04-assign-haplotype-backgrounds.Rmd`), let's assign a putative background lineage (`Genome 1` or `Genome 2`) to each of the major clusters.
