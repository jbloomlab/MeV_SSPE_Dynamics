---
title: "9. Visualize Phylogenetic Tree"
author:
    - "Will Hannon"
...
I took the sequences for each of these haplotypes and generated a phylogenetic tree using `iqtree`. The phylogenetic relationship of the clusters was determined by `SPRUCE` with the total set of trees filtered down by bridging reads.
