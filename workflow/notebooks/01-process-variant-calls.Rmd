...
png(file=paste(figure.dir, "caller_upset_plot.png", sep=""), width=8, height=5, units="in", res = 300)
caller.upset
dev.off()
...
ggsave(paste(figure.dir, "extended-data-figure-3.png"), width = 18, height = 12, dpi = 300)
